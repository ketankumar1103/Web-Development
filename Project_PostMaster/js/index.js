// console.log(`Project - PostMaster`);
...
// // If the user selects Custom Parameters, hide the json box
...
// // If the user selects Json, hide the params box 
...
//                             </div>
//                             <div class="col-md-4">
//                                 <input type="text" class="form-control" id="parameterValue1" placeholder="Enter Parameter ${addedParamsCount + 2} Value">
//                             </div>
//                             <button class="btn btn-primary deleteParam">-</button>
//                         </div>
//                     </div> `;
//                     // Convert the element string to DOM node
//                     let paramElement = document.getElementFromString('string');
//     params.appendChild(paramElement);
//     // Add an event listener to remove the parameter on clicking - button
//     let deleteParam = document.getElementsByClassName('deleteParam');
//     for (const items of deleteParam) {
//         deleteParam.addEventListener('click', (e) => {
