console.log(`Exercise for making a Dictionary.`);
...
// console.log(`The Results in Object are: `, myObj['results']);
// let meanings = document.getElementById('meanings');
// meanings.addEventListener('click', () => {
//   console.log(`Someone clicked Get meanings button `);
//   populate();
// });
...
//     html += `<li>The definition of example is: ${element.definition}</li>`
//     // console.log(`Task accomplished, Prepaering to display on screen by inserting in DOM.`);  
//   });
